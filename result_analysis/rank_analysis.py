    ...
    def all_parameters():
        if has_column:
            boxplot_dict = plt.boxplot([np.log10(data['T1'] / data['T2']),
                                        ...
                                        np.log10(equal1_data['T1'] / equal1_data['T2']),
                                        np.log10(equalN_data['T1'] / equalN_data['T2']),
                                        np.log10(lessN_data['T1'] / lessN_data['T2']),
            ...
            colors = ['red', 'red', 'blue', 'blue', 'green', 'green', 'orange', 'orange', 'orange', 'brown', 'brown',
            ...
            # Define the colors for the desired boxes
            colors = ['blue', 'blue', 'green', 'green', 'orange', 'orange', 'orange', 'brown', 'brown', 'cyan', 'cyan',
                      'magenta', 'magenta']
        ...
        plt.subplots_adjust(left=0.14, right=0.97, top=0.94, bottom=0.21)  # Adjust the values as per your requirements
