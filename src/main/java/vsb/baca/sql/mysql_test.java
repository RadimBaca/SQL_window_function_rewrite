...
import vsb.baca.sql.benchmark.benchmark_mysql;
...
public class mysql_test {
    ...
    private static final String DROPINDEXES_PB_OB = "sql/agg_test/agg_pb_ob_dropindexes_mysql.sql";
    ...
    private static final String DROPINDEXES_PB = "sql/agg_test/agg_pb_dropindexes_mysql.sql";
    ...
    private static void count_bp_ob_test(ArrayList<Integer> selectivity) throws Exception {
        ArrayList<Pair<String, String>> queriesNoPadding = benchmark_mysql.generateQueriesWithSelectivity(selectivity, COUNT_PB_OB_TEMP);
        ArrayList<Pair<String, String>> queriesPadding = benchmark_mysql.generateQueriesWithSelectivity(selectivity, COUNT_PB_OB_TEMP_PADDING);
        ArrayList<run_setup> run_setups = generate_run_setups(queriesNoPadding, queriesPadding);
        mysql_runner.prepare_run(run_setups, DROPINDEXES_PB_OB, CREATEINDEXES_PB_OB);
    }

    private static void count_bp_test(ArrayList<Integer> selectivity) throws Exception {
        ArrayList<Pair<String, String>> queriesNoPadding = benchmark_mysql.generateQueriesWithSelectivity(selectivity, COUNT_PB_TEMP);
        ArrayList<Pair<String, String>> queriesPadding = benchmark_mysql.generateQueriesWithSelectivity(selectivity, COUNT_PB_TEMP_PADDING);
        ArrayList<run_setup> run_setups = generate_run_setups(queriesNoPadding, queriesPadding);
        mysql_runner.prepare_run(run_setups, DROPINDEXES_PB, CREATEINDEXES_PB);
    }

    private static void min_bp_ob_test(ArrayList<Integer> selectivity) throws Exception {
        ArrayList<Pair<String, String>> queriesNoPadding = benchmark_mysql.generateQueriesWithSelectivity(selectivity, MIN_PB_OB_TEMP);
        ArrayList<Pair<String, String>> queriesPadding = benchmark_mysql.generateQueriesWithSelectivity(selectivity, MIN_PB_OB_TEMP_PADDING);
        ArrayList<run_setup> run_setups = generate_run_setups(queriesNoPadding, queriesPadding);
        mysql_runner.prepare_run(run_setups, DROPINDEXES_PB_OB, CREATEINDEXES_PB_OB);
    }

    private static void min_bp_test(ArrayList<Integer> selectivity) throws Exception {
        ArrayList<Pair<String, String>> queriesNoPadding = benchmark_mysql.generateQueriesWithSelectivity(selectivity, MIN_PB_TEMP);
        ArrayList<Pair<String, String>> queriesPadding = benchmark_mysql.generateQueriesWithSelectivity(selectivity, MIN_PB_TEMP_PADDING);
        ArrayList<run_setup> run_setups = generate_run_setups(queriesNoPadding, queriesPadding);
        mysql_runner.prepare_run(run_setups, DROPINDEXES_PB, CREATEINDEXES_PB);
    }
